...
That's where `git stash` comes in! As the name suggests, this command adds your uncommitted changes to a stash that you can access later. This stash is stored locally on your machine and doesn't get pushed up to Github or any other version control system.
