...
In this activity, you will write code to create a function that takes in a string and determines whether it is a palindrome. A **palindrome** is any string spelled the same forwards as it is backwards.
